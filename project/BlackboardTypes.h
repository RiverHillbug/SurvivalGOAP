...
static const std::string WEAPON_SLOT_PARAM{ "WeaponSlot" };
static const std::string MEDKIT_SLOT_PARAM{ "MedkitSlot" };
static const std::string FOOD_SLOT_PARAM{ "FoodSlot" };
...
static const std::string HAS_TARGET_ITEM_PARAM{ "HasTargetItem" };
static const std::string HAS_TARGET_ENEMY_PARAM{ "HasTargetEnemy" };
static const std::string HAS_WEAPON_PARAM{ "HasPistol" };
...
static const std::string HAS_LOW_HEALTH_PARAM{ "HasLowHealth" }; //use medkit
static const std::string HAS_LOW_ENERGY_PARAM{ "HasLowEnergy" }; //eat food
